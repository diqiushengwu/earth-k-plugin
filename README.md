...
```
使用Github
git clone https://github.com/diqiushengwu/earth-k-plugin.git ./plugins/earth-k-plugin/
使用Gitee
git clone https://gitee.com/diqiushengwu/earth-k-plugin.git ./plugins/earth-k-plugin/
```
